                            ...
                            <form action="{{route('object.update', $object->id)}}" method="post">
                                ...
                                <div class="block-add-object-item content-add-item">
                                    <div class="add-schedule-row add-content-row">
                                        ...
                                        <div class="add-object-row-column add-content-row-column">
                                            <input name="full_name" value="{{$object->full_name}}" type="text"
                                    ...
                                    <div class="add-object-row add-content-row">
                                        ...
                                        <div class="add-object-row-column add-content-row-column">
                                            <input name="abbreviated_name" value="{{$object->abbreviated_name}}"
                                                   type="text" class="text-field-add-content" autocomplete="off"
                                                   required/>
                                        </div>
                                    </div>
                                </div>
